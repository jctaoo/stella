...
export const demoPassage1: PassageAbbr = {
  identifier: "AB123",
  title: "利用快速傅立叶转换求卷积",
...
export const demoPassage2: PassageAbbr = {
  identifier: "AB121",
...
export const demoPassage3: PassageAbbr = {
  identifier: "AB122",
...
export const demoPassage4: PassageAbbr = {
  identifier: "1B122",
  title: "文言文编程火了!!",
  abbr:   "GitHub Services 是 GitHub 官方推出的持续集成/部署模块服务（CI/CD），和 jenkins、Travis CI 是同一类产品定位。",
  about: {
...
export const demoPassage5: PassageAbbr = {
  identifier: "4B122",
  title: "[译]使用Three.js制作有粘稠感的图像悬停效果",
  abbr:   "作为Flash的替代者WebGL在近几年随着像Three.js, PIXI.js, OGL.js这样的库而变得越来越火。它们对于创建空白板非常有用，唯一的限制只有你的想象力。我们看到越来越多的WebGL创建的效果微妙地集成到交互界面中，以进行悬停，滚动或显示效果。比如 Hello Monday 或者是 cobosrl.co.",
  about: {
...
export const demoPassage6: PassageAbbr = {
  identifier: "5B122",
  title: "编写自己的 GitHub Action，体验自动化部署",
  abbr:   "GitHub Services 是 GitHub 官方推出的持续集成/部署模块服务（CI/CD），和 jenkins、Travis CI 是同一类产品定位。",
  about: {
